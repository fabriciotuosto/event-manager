...
public class Photo {
    ...
    /**
     * @param id to identify the photo
     */
    @Deprecated
    ...
    /**
     * @param photoBuilder to build photo
     */
    ...
    public static class PhotoBuilder implements Builder<Photo> {
        ...
        /**
         * @param tooltip to display over the photo
         * @return photoBuilder to chain invocations
         */
